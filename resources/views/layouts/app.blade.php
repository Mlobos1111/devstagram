...
<body class="bg-gray-100">
    <header class="p-5 border-b bg-white shadow">
        <div class="container mx-auto flex justify-between">
            ...
            <nav class="flex gap-2 items-center">
                ...
                <a href="{{route('posts.index',auth()->user()->username)}}" class="font-bold text-gray-600 text-sm ">Hola:
            ...
            <nav>
                ...
                <a href={{"register"}} class="font-bold uppercase text-gray-600 text-sm ">Crear Cuenta</a>
            </nav>
            @endguest
    ...
    <footer class="text-center mt-10 p-5 text-gray-500 font-bold uppercase ">
        ...
        <p>Devstagram-All rights reserved 2024-Mlobos11</p>
